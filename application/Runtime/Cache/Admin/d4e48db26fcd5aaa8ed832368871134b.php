...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/ECshop/admin.php/Attribute/up" method="post">
            <table width="90%" id="general-table" align="center">
                ...
                <tr>
                    ...
                    <td>
                        <input  type="text" name="attr_name" value="<?php echo $editinfo['attr_name']?>" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="radio" name="attr_type" value="唯一" <?php if($editinfo['attr_type']=="唯一"){echo "checked='checked'";}?>/>唯一
                        <input type="radio" name="attr_type" value="可选" <?php if($editinfo['attr_type']=="可选"){echo "checked='checked'";}?> />可选
                    </td>
                </tr>
                <tr>
                    <td class="label">属性可选值：</td>
                    <td>
                        <textarea rows="6" cols="60" name="attr_option_values"><?php echo $editinfo['attr_option_values']?></textarea>
                    </td>
                </tr>
                <tr>
