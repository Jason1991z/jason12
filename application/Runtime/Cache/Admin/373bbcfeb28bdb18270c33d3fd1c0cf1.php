...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
          <?php
 $primodel=D("privilege"); $pridata=$primodel->getbtn(); foreach($pridata as $k=>$v){ ?>
            <li class="explode" key="02_cat_and_goods" name="menu">
            <?php echo $v['pri_name']?>
                <ul>
                  <?php foreach($v['children'] as $k1=>$v1){?>
                    <li class="menu-item"><a href="/ECshop/admin.php/<?php echo $v1['controller_name']?>/<?php echo $v1['action_name']?>" target="main-frame"><?php echo $v1['pri_name']?></a></li>
                  <?php }?>
                </ul>
            </li>
          <?php }?>
