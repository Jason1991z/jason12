...
.explode {
  background:url(/ECshop/Public/Admin/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/ECshop/Public/Admin/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/ECshop/Public/Admin/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/ECshop/Public/Admin/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            商品管理
                <ul>
                    <li class="menu-item"><a href="/ECshop/admin.php/goods/lst" target="main-frame">商品列表</a></li>
                    <li class="menu-item"><a href="/ECshop/admin.php/goods/index" target="main-frame">添加新商品</a></li>
                    <li class="menu-item"><a href="/ECshop/admin.php/category/lst" target="main-frame">商品分类</a> </li>
                    <li class="menu-item"><a href="/ECshop/admin.php/type/lst" target="main-frame">商品类型</a></li>
                    <li class="menu-item"><a href="/ECshop/admin.php/brand/lst" target="main-frame">商品品牌</a></li>
            ...
            会员管理
                <ul>
                    <li class="menu-item"><a href="/ECshop/admin.php/Member/lst" target="main-frame">会员列表</a></li>
                    <li class="menu-item"><a href="/ECshop/admin.php/Member/add" target="main-frame">添加会员</a></li>
                    <li class="menu-item"><a href="/ECshop/admin.php/Member/leave" target="main-frame">会员留言</a></li>
                </ul>
            </li>
        </ul>
    </div>
...
<script type="text/javascript" src="/ECshop/Public/Admin/Js/global.js"></script>
<script type="text/javascript" src="/ECshop/Public/Admin/Js/utils.js"></script>
<script type="text/javascript" src="/ECshop/Public/Admin/Js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/ECshop/Public/Admin/Images/menu_minus.gif' : '/ECshop/Public/Admin/Images/menu_plus.gif';
