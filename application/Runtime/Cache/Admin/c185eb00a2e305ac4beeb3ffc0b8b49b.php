...
<script type="text/javascript">
    function del(id){
        if(confirm("确定要删除该记录吗?")){
            window.location="/ECshop/admin.php/privilege/delpri/id/"+id;
        }
    }
</script>
...
<form method="post" action="" name="listForm" onsubmit="">
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1" >
            ...
            <?php foreach($privilege as $v){?>
            <tr class="tron">
                <td align="left" class="first-cell"><span><?php echo str_repeat("-",8*$v['level']).$v['pri_name']?></span></td>
                <td align="left" class="first-cell"><span><?php echo $v['module_name']?></span></td>
                <td align="left" class="first-cell"><span><?php echo $v['controller_name']?></span></td>
                <td align="left" class="first-cell"><span><?php echo $v['action_name']?></span></td>
                <td align="center"><a href="/ECshop/admin.php/privilege/edit/id/<?php echo $v['id']?>">修改</a> | <a href="javascript:del(<?php echo $v['id']?>)">删除</a></td>
            </tr>
            <?php }?>
        </table>
