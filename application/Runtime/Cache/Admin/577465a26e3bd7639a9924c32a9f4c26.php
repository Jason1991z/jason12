...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/ECshop/admin.php/role/up ?>" method="post">
            <table width="90%" id="general-table" align="center">
                ...
                <tr >
                    ...
                    <td><input type="text" name="role_name" value="<?php echo $editinfo['role_name']?>"size="30" />
                ...
                <tr>
                    ...
                    <td>
                        <?php foreach($tree as $k=>$v){ $_arr=explode(",",$rpinfo); if(in_array($v['id'],$_arr)){ $check="checked='checked'"; }else{ $check=""; } ?>
