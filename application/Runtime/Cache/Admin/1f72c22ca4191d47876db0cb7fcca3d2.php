...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/ECshop/admin.php/Member/up ?>" method="post">
            <table width="90%" id="general-table" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="level_name" value="<?php echo $editinfo['level_name']?>"size="30" />
                ...
                <tr>
                    ...
                    <td><input type="text" name="jifen_bottom" value="<?php echo $editinfo['jifen_bottom']?>"size="30" />
                        <span class="require-field">*</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="jifen_top" value="<?php echo $editinfo['jifen_top']?>"size="30" />
                        <span class="require-field">*</span>
                    </td>
                </tr>
