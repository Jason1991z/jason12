...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="/ECshop/Public/Admin/Images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
        ...
        <div id="send_info">
            <span>你好,<?php echo $_SESSION['userinfo']['username']?></span>
            <a href="#" target="main-frame" class="fix-submenu">清除缓存</a>
            <a href="/ECshop/admin.php/login/logout" target="_top" class="fix-submenu">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
    <ul>
        ...
        <li><a href="/ECshop/admin.php/Index/index" target="main-frame">起始页</a></li>
        <li><a href="/ECshop/admin.php/Goods/lst" target="main-frame">商品列表</a></li>
