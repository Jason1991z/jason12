...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/ECshop/admin.php/Brand/up ?>" method="post">
            <table width="90%" id="general-table" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="brand_name" value="<?php echo $editinfo['brand_name']?>"size="30" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="site_url" value="<?php echo $editinfo['site_url']?>" size="20"/>
                        <span class="require-field">*</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div><?php showImg($editinfo['logo'],150)?></div>
