...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/ECshop/admin.php/Member/add" method="post">
            <table width="90%" id="general-table" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="jifen_bottom" value="" size="30" />
                        <span class="require-field">*</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="jifen_top" value="" size="30" />
                        <span class="require-field">*</span>
                    </td>
                </tr>
