...
<script type="text/javascript">
    function del(id){
        if(confirm("确定要删除该记录吗?")){
            window.location="/ECshop/admin.php/Member/delmember/id/"+id;
        }
    }
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <tr class="tron">
                ...
                <td align="center"><a href="/ECshop/admin.php/Member/edit/id/<?php echo $v['id']?>">修改</a> | <a href="javascript:del(<?php echo $v['id']?>)">删除</a></td>
            </tr>
            <?php }?>
        </table>
