...
<script type="text/javascript">
    function del(id){
        if(confirm("确定要删除该记录吗?")){
            window.location="/ECshop/admin.php/Category/delcategory/id/"+id;
        }
    }
</script>
...
<form method="post" action="" name="listForm" onsubmit="">
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1" style="width:800px" align="center">
            <tr>
            ...
            <tr class="tron">
                <td align="left" class="first-cell"><span><?php echo str_repeat("-",8*$v['level']).$v['cat_name']?></span></td>
                <td align="center"><a href="/ECshop/admin.php/Category/edit/id/<?php echo $v['cat_id']?>">修改</a> | <a href="javascript:del(<?php echo $v['cat_id']?>)">删除</a></td>
            </tr>
            <?php }?>
        </table>
