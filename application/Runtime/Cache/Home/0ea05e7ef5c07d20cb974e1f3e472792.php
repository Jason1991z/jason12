...
<!-- 引入这个页面特有的CSS和JS -->
<script type="text/javascript" src="/ECshop/public/Home/js/goods.js"></script>
<script type="text/javascript" src="/ECshop/public/Home/js/jqzoom-core.js"></script>
<link rel="stylesheet" href="/ECshop/public/Home/style/jqzoom.css" type="text/css">
<link rel="stylesheet" href="/ECshop/public/Home/style/goods.css" type="text/css">
<link rel="stylesheet" href="/ECshop/public/Home/style/common.css" type="text/css">
...
<!-- jqzoom 效果 -->
	<script type="text/javascript">
		...
		$.ajax({
			type:"get",
			url:"/ECshop/index.php/Index/dishistory?id="+"<?php echo I('get.id')?>",
			dataType:"json",
			success:function(data){
				var str="";
				$(data).each(function(k,v){
					str +="<dl>";
					str +="<dt><a href=''><img src='/ECshop/public/uploads/"+v.mid_logo+"' alt='' /></a></dt>";
					str +="<dd><a href=''>"+v.goods_name+"</a></dd>";
					str +="</dl>";
				});
				$("#history").html(str);
			}
		...
		$.ajax({
			type:"get",
			url:"/ECshop/index.php/Index/ajaxGetPrice?goods_id="+<?php echo I("get.id");?>,
			success:function(data){
				
				var i="";
				i +="<span>会员价格：</span> <strong>￥"+data+"</strong> ";
				$("#real_price").html(i);
			}
		});
	</script>
...
<!-- 商品页面主体 start -->
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="/ECshop/index.php/Index/index">首页</a> >
			<?php  $count=count($catInfo); for($i=$count-1;$i>=0;$i--){ ?>
			 	<a href=""><?php echo $catInfo[$i]['cat_name']?></a> >
			<?php }?>
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/ECshop/Public/Home/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/ECshop/Public/Home/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/ECshop/Public/Home/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/ECshop/Public/Home/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/ECshop/Public/Home/images/relate_view5.jpg" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo $viewPath.$info['mid_logo']?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<?php showImg($info['big_logo'])?>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<!-- 第一个是logo小图 -->
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo $viewPath.$info['big_logo']; ?>',largeimage: '<?php echo $viewPath.$info['mbig_logo']; ?>'}">
									<?php showImg($info['sm_logo']); ?></a>
								</li>
								<!-- 循环相册中的图片　-->
								<?php foreach ($gpData as $k => $v): ?>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo $viewPath.$v['mid_pic']; ?>',largeimage: '<?php echo $viewPath.$v['big_pic']; ?>'}"><?php showImg($v['sm_pic']); ?></a>
								</li>
								<?php endforeach; ?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="shop_price"><span>本店价：</span> <strong  style="color:black;">￥<?php echo $info['shop_price']; ?></strong> <a href="">(降价通知)</a></li>
						...
						<li><strong id="real_price" style="color:#BE0000; font-size:14px;"></strong></li>
						<li><span>上架时间：</span><?php echo $info['addtime']; ?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星
					</ul>
					<!-- 加入购物车的表单 -->
					<form action="/ECshop/index.php/Cart/adds" method="post" class="choose">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="desc mt10">
							...
							<img src="/ECshop/Public/Home/images/desc1.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/ECshop/Public/Home/images/desc2.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/ECshop/Public/Home/images/desc3.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/ECshop/Public/Home/images/desc4.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/ECshop/Public/Home/images/desc5.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/ECshop/Public/Home/images/desc6.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/ECshop/Public/Home/images/desc7.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/ECshop/Public/Home/images/desc8.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/ECshop/Public/Home/images/desc9.jpg" alt="" />
						</div>
					</div>
					<!-- 商品介绍 end -->
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/ECshop/Public/Home/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/ECshop/Public/Home/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/ECshop/Public/Home/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
