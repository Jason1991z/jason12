...
<link rel="stylesheet" href="/ECshop/Public/Home/style/fillin.css" type="text/css">
<script type="text/javascript" src="/ECshop/Public/Home/js/cart2.js"></script>
		...
		<div class="fillin_bd">
			...
			<div class="address">
				...
				<div class="address_select none">
					...
					<form action="/ECshop/index.php/Orders/add" method="POST" class="none" name="address_form">
						<ul>
							<li>
