<?php
//下拉框的自定义函数
function showSelect($table_name,$select_name,$value_id,$value_name,$bra=""){
    $select="";
    $brand_model=D("$table_name");
    $selectinfo=$brand_model->field("$value_id,$value_name")->select();


    $select.="<select name='$select_name'>";
    $select.="<option>请选择</option>";
    foreach($selectinfo as $k=>$v) {
        ...
        $select .= "<option value='".$v["$value_id"]."' $select_b>".$v["$value_name"]."</option>";
    }
    $select.="</select>";
