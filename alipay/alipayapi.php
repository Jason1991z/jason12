...
/**************************请求参数**************************/
        ...
        $notify_url = "localhost/Ecshop/index.php/Home/Order/receive";
        //需http://格式的完整路径，不能加?id=123这类自定义参数

        //页面跳转同步通知页面路径 ： 支付成功之后跳转的页面
        $return_url = "localhost/Ecshop/index.php/Home/Order/pay_success";
        ...
        //商品展示地址 ： 定单详细页
        $show_url = 'localhost/Ecshop/index.php/Home/Order/view/id/'.$orderId;
